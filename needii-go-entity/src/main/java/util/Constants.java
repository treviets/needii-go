...
public final class Constants {
    ...
    public static final String DOMAIN_NAME = "https:needii.com/admin";
    ...
    public static final String SAVE_LOGO_SUPPLIER_PATH = "/static/images/uploadimg/supplier/logo";
    ...
    public static final String RESOURCE_DOMAIN = "http://149.28.147.158:8089/needii";
    public static final String RESOURCE_PHYSIC_PATH = "/opt/tomcat/webapps/needii";
    ...
    public static final double GOOGLE_MAP_DISTANCE_KILOMETER = 1;
    public static final String ELASTICSEARCH_DOMAIN = "http://localhost:9200";
    public static final int SUPPLIER_DEFAULT_ROLE_ID = 1;
    //
}
